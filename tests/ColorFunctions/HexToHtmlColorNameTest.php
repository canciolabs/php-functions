...
use function CancioLabs\Functions\ColorFunctions\hex_to_html_color_name;

class HexToHtmlColorNameTest extends CustomTestCase
{
     ...
     */
    public function shouldReturnHtmlColorNameWhenHexColorIsValid(string $hex_color, string $html_color_name): void
    {
        $this->assertSame($html_color_name, hex_to_html_color_name($hex_color));
    }
    ...
    public function shouldThrowExceptionWhenHexColorIsInvalid(string $invalid_hex_color): void
    {
        ...
        hex_to_html_color_name($invalid_hex_color);
    }
