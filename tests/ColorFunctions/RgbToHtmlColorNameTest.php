...
use function CancioLabs\Functions\ColorFunctions\rgb_to_html_color_name;

class RgbToHtmlColorNameTest extends CustomTestCase
{
     ...
     */
    public function shouldReturnHtmlColorNameWhenRgbColorIsValid(string $rgb_color, string $html_color_name): void
    {
        $this->assertSame($html_color_name, rgb_to_html_color_name($rgb_color));
    }
    ...
    public function shouldThrowExceptionWhenRgbColorIsInvalid(string $invalid_rgb_color): void
    {
        ...
        rgb_to_html_color_name($invalid_rgb_color);
    }
